...
public class NewsThemeFactory extends AbstractFactory<NewsTheme> {
    ...
    private static final Class<NewsTheme> ManagedClass = NewsTheme.class;

    private static final Logger log = LoggerFactory.getLogger(NewsThemeFactory.class);

    @Override
    public NewsTheme create() throws NoSuchMethodException {
        return create(ManagedClass);
    }

    @Override
    public NewsTheme create(Map<String, Object> args) throws NoSuchMethodException {
        return create(ManagedClass, args);
    }

    @Override
    public NewsTheme create(boolean allArgs, Map<String, Object> args) throws NoSuchMethodException {
        return create(allArgs, ManagedClass, args);
    }
    ...
    public NewsTheme create(@NonNull String title, @NonNull String data,
        ...
        return create(NewsTheme.class, args);
    }
